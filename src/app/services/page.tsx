...
const SERVICES = [
  {
    id: "ai-systems", cmd: "avy serve ai-pipelines",
    icon: Cpu, color: "#10b981",
    title: "AI Applications & LLM Pipelines",
    cat: "ARTIFICIAL INTELLIGENCE",
    desc: "Custom generative AI applications, streaming Groq LLM pipelines, autonomous tool-calling agents, and vector RAG document retriever knowledge bases.",
    deliverables: ["Custom Groq LLM Integration", "RAG Vector Knowledge Bases", "Autonomous Agent Workflows", "Structured JSON Tool Calling"],
    timeline: "3–5 weeks",
  },
  {
    id: "saas", cmd: "avy serve saas-platform",
    icon: Layout, color: "#34d399",
    title: "Full-Stack Custom SaaS Platforms",
    cat: "CLOUD PLATFORMS",
    desc: "Multi-tenant cloud applications, automated subscription billing engines, telemetry dashboards, and resilient database architectures.",
    deliverables: ["Multi-Tenant Architecture", "Stripe Billing & Subscriptions", "Telemetry & Monitoring UI", "Row-Level Security & RBAC"],
    timeline: "4–8 weeks",
  },
  {
    id: "web", cmd: "avy serve web-platform",
    icon: Globe, color: "#6ee7b7",
    title: "High-Performance Web Applications",
    cat: "FRONTEND ARCHITECTURE",
    desc: "Modern web applications built with Next.js 16 App Router, React 19, strict TypeScript, and Tailwind CSS v4 with optimized page loads.",
    deliverables: ["Next.js 16 App Router", "100% Strict TypeScript", "Tailwind CSS v4 Utility Styling", "Zero-Layout-Shift CLS:0"],
    timeline: "2–4 weeks",
  },
  {
    id: "motion", cmd: "avy serve gpu-motion",
    icon: Zap, color: "#a7f3d0",
    title: "GPU Motion & 3D Web Graphics",
    cat: "CREATIVE ENGINEERING",
    desc: "Creative engineering using GSAP 3 ScrollTrigger, Framer Motion spring physics, Lenis smooth scrolling, and performant Three.js WebGL shaders.",
    deliverables: ["GSAP 3 ScrollTrigger Timelines", "Three.js WebGL Shaders", "Lenis Smooth Scroll", "Framer Motion Spring Physics"],
    timeline: "3–6 weeks",
  },
  {
    id: "security", cmd: "avy serve security-audit",
    icon: ShieldCheck, color: "#059669",
    title: "Security Architecture & Audits",
    cat: "SECURITY ENGINEERING",
    desc: "End-to-end security architecture, row-level security policies, authentication flows, and production hardening for enterprise SaaS platforms.",
    deliverables: ["Supabase RLS Policies", "Auth Provider Integration", "OWASP Security Hardening", "CSP & Rate Limiting"],
    timeline: "1–3 weeks",
  },
];
