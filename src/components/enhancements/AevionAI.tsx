    ...
    const founders = [
      {
        ...
        discipline: "Architecture • Full-Stack • AI Systems",
        focus:
          "The builder behind Aevion — responsible for its architecture, interface, engineering, AI systems and product experience, conceived and built from the ground up.",
        quote: "Software should be an extension of human will. Eliminate friction until only raw intelligence remains.",
        tags: ["Architecture", "Full-Stack", "AI Systems", "Lead Engineer"],
