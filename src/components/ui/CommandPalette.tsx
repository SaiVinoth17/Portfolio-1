...
export default function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    {
      id: "about",
      title: "About Founder & Timeline (The Human Layer)",
      category: "Navigation",
      icon: User,
      shortcut: "A",
    ...
    {
      id: "projects",
      title: "Projects & Case Studies (The Archive)",
      category: "Navigation",
      icon: FolderGit2,
      shortcut: "P",
    ...
    {
      id: "tech-stack",
      title: "Tech Stack & Architecture (The Lab)",
      category: "Navigation",
      icon: Cpu,
      shortcut: "T",
    ...
    {
      id: "showcase",
      title: "3D & WebGL Laboratory (Showcase)",
      category: "Navigation",
      icon: Sparkles,
      shortcut: "S",
    ...
    {
      id: "services",
      title: "Services & Capabilities Engine",
      category: "Navigation",
      icon: Layers,
    ...
    {
      id: "blog",
      title: "Technical Research & Articles",
      category: "Navigation",
      icon: BookOpen,
