...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            if (e.deltaY > 0) {
                // Scrolling down: internal scroll up to MAX_SCROLL
                ...
                // Scrolling up: reverse internal animation down to 0
                if (scrollRef.current > 0) {
                    ...
                    // Prevent page jump back to top when scrolling up inside container
                    e.preventDefault();
                }
            }
        };
        ...
        const handleTouchMove = (e: TouchEvent) => {
            ...
            if (deltaY > 0 && scrollRef.current < MAX_SCROLL) {
                e.preventDefault();
    ...
    return (
        <div ref={containerRef} data-lenis-prevent="true" className="relative w-full h-full bg-[#FAFAFA] overflow-hidden">
            {/* Container */}
