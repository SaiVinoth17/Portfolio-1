...
const DEFAULT_STORE: DataStore = {
  ...
  projects: [
    ...
    },
    {
      ...
      link: "https://www.ootythegamingkingdom.com/",
      github: "https://github.com/aevionstudio",
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    },
    {
      ...
      link: "https://houseofpetalssooty.com/",
      github: "https://github.com/aevionstudio",
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    },
    {
      ...
      subtitle: "Motion Operating System & Brand Experience",
      category: "Brand Motion & Experimental Web OS",
      status: "PUBLISHED",
      metrics: "120 FPS WebGL Motion • Strict Type Safety",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1200&q=80",
      link: "https://www.aevionstudio.in/",
      github: "https://github.com/aevionstudio",
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    },
